...
<head>
    ...
    <!-- Mengimpor font Droid Sans dari Google Fonts -->
            ...
            <div class="col-md-8 bgcard d-flex justify-content-center align-item-center">
                <div class="card bg-dark text-white shadow-lg">
                    <div class="card-body">
                        ...
                        <h1 class="display-1 text-orange">404</h1>
                        <!-- Deskripsi error -->
                        <h2 class="display-4">Something's missing.</h2>
                        <hr class="my-4 border-orange">
                        <!-- Pesan penjelasan bahwa halaman tidak ditemukan -->
                        <p class="lead">Sorry, we can't find that page. You'll find lots to explore on the home page.</p>
